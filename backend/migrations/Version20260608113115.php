 ...
 */
final class Version20260608113115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipo (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, escudo VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE foro_global (id INT AUTO_INCREMENT NOT NULL, mensaje LONGTEXT NOT NULL, fecha DATETIME NOT NULL, usuario_id INT DEFAULT NULL, INDEX IDX_A8CE5850DB38439E (usuario_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE jornada (id INT AUTO_INCREMENT NOT NULL, fecha_inicio DATETIME NOT NULL, fecha_final DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE jugador (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, posicion VARCHAR(255) NOT NULL, edad INT NOT NULL, nacionalidad VARCHAR(255) NOT NULL, foto VARCHAR(255) NOT NULL, equipo_id INT DEFAULT NULL, INDEX IDX_527D6F1823BFBED (equipo_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE liga (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, privada TINYINT NOT NULL, max_miembros INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE noticia (id INT AUTO_INCREMENT NOT NULL, titulo VARCHAR(255) NOT NULL, categoria VARCHAR(255) NOT NULL, texto LONGTEXT NOT NULL, fecha DATE DEFAULT CURRENT_DATE NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE puntuacion (id INT AUTO_INCREMENT NOT NULL, puntos INT NOT NULL, jugador_id INT DEFAULT NULL, jornada_id INT DEFAULT NULL, INDEX IDX_ABF67C3FB8A54D43 (jugador_id), INDEX IDX_ABF67C3F26E992D9 (jornada_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE usuario_fantasy (id INT AUTO_INCREMENT NOT NULL, puntos_totales INT NOT NULL, creador TINYINT NOT NULL, usuario_id INT DEFAULT NULL, liga_id INT DEFAULT NULL, INDEX IDX_69056C44DB38439E (usuario_id), INDEX IDX_69056C44CF098064 (liga_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
