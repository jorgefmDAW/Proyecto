 ...
 */
final class Version20260521081527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE solicitud ADD liga_id INT NOT NULL, ADD usuario_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_96D27CC0CF098064 ON solicitud (liga_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE solicitud_liga (solicitud_id INT NOT NULL, liga_id INT NOT NULL, INDEX IDX_3B7480801CB9D6E4 (solicitud_id), INDEX IDX_3B748080CF098064 (liga_id), PRIMARY KEY (solicitud_id, liga_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE solicitud_usuario (solicitud_id INT NOT NULL, usuario_id INT NOT NULL, INDEX IDX_6F3C3DC1CB9D6E4 (solicitud_id), INDEX IDX_6F3C3DCDB38439E (usuario_id), PRIMARY KEY (solicitud_id, usuario_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_96D27CC0CF098064 ON solicitud');
        $this->addSql('DROP INDEX IDX_96D27CC0DB38439E ON solicitud');
        $this->addSql('ALTER TABLE solicitud DROP liga_id, DROP usuario_id');
    }
}
